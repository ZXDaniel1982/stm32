...
PageEntity_t *Page_Func_Temperature(KeyEnum_t key, Logger logger, PageEntity_t *page)
{
    ...
    case Right:
    case Left:
        return Page_CreatePage(Spc_GetNextPage(logger, key, Temperature), logger, page->publisher);
    case Update:
...
PageEntity_t *Page_Func_TempRTDA(KeyEnum_t key, Logger logger, PageEntity_t *page)
{
    ...
    case Right:
    case Left:
        return Page_CreatePage(Spc_GetNextPage(logger, key, TempRTDA), logger, page->publisher);
    case Update:
...
PageEntity_t *Page_Func_TempRTDB(KeyEnum_t key, Logger logger, PageEntity_t *page)
{
    ...
    case Left:
    case Right:
        return Page_CreatePage(Spc_GetNextPage(logger, key, TempRTDB), logger, page->publisher);
    case Update:
