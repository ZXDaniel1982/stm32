...
PageEntity_t *Page_Func_Enegy(KeyEnum_t key, Logger logger, PageEntity_t *page)
{
    ...
    case Left:
        return Page_CreatePage(MinVoltage, logger, page->publisher);
    case Prog:
        return Page_CreatePage(Program, logger, page->publisher);
    case Def:
        return Page_CreatePage(Default, logger, page->publisher);
    case Right:
        return Page_CreatePage(Cost, logger, page->publisher);
    case Update:
...
PageEntity_t *Page_Func_Cost(KeyEnum_t key, Logger logger, PageEntity_t *page)
{
    ...
    case Act:
        return Page_CreatePage(Actual, logger, page->publisher);
    case Left:
        return Page_CreatePage(Enegy, logger, page->publisher);
    case Prog:
        return Page_CreatePage(Program, logger, page->publisher);
    case Def:
        return Page_CreatePage(Default, logger, page->publisher);
    case Right:
        return Page_CreatePage(OnTime, logger, page->publisher);
    case Update:
