...
void DMA_Init()
{
    MODIFY_REG(DMA1_Channel2->CCR, (DMA_CCR_DIR | DMA_CCR_MEM2MEM | DMA_CCR_PL | DMA_CCR_CIRC | DMA_CCR_PINC | DMA_CCR_MINC |
                DMA_CCR_PSIZE | DMA_CCR_MSIZE), (DMA_CCR_MINC));
    MODIFY_REG(DMA1_Channel3->CCR, (DMA_CCR_DIR | DMA_CCR_MEM2MEM | DMA_CCR_PL | DMA_CCR_CIRC | DMA_CCR_PINC | DMA_CCR_MINC |
                DMA_CCR_PSIZE | DMA_CCR_MSIZE), (DMA_CCR_DIR | DMA_CCR_MINC));
}
