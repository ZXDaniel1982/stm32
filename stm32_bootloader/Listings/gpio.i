...
#line 2 "Core\\Src\\gpio.c"
#line 3 "Core\\Src\\gpio.c"
...
#line 4 "Core\\Src\\gpio.c"

static const GPIO_PINS_t GPIO_PINS_L[] = {
    {((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000C00U)), (0x1U << (5U)), ((0x3U << (22U)) | (0x3U << (20U))), (0x2U << (20U))},      
    {((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000800U)), (0x1U << (4U)), ((0x3U << (18U)) | (0x3U << (16U))), (0x3U << (16U))},  

    
    {((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000800U)), (0x1U << (5U)),  ((0x3U << (22U))  | (0x3U << (20U))),  ((0x2U << (22U))  | (0x3U << (20U)))},
    {((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000800U)), (0x1U << (6U)),  ((0x3U << (26U))  | (0x3U << (24U))),  (0x1U << (26U))},
    {((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000800U)), (0x1U << (7U)),  ((0x3U << (30U))  | (0x3U << (28U))),  ((0x2U << (30U))  | (0x3U << (28U)))},
    
    
    {((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00001400U)), (0x1U << (2U)),  ((0x3U << (10U))  | (0x3U << (8U))),  ((0x2U << (10U))  | (0x3U << (8U)))},
};
static const GPIO_PINS_t GPIO_PINS_H[] = {
    
    {((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000800U)), (0x1U << (9U)),  ((0x3U << (6U))  | (0x3U << (4U))),  ((0x2U << (6U))  | (0x3U << (4U)))},
    {((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00000800U)), (0x1U << (10U)), ((0x3U << (10U)) | (0x3U << (8U))), (0x1U << (10U))},
    
    
    {((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00001000U)), (0x1U << (8U)),  ((0x3U << (2U))  | (0x3U << (0U))),  ((0x2U << (2U))  | (0x3U << (0U)))},
    {((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00001000U)), (0x1U << (9U)),  ((0x3U << (6U))  | (0x3U << (4U))),  ((0x2U << (6U))  | (0x3U << (4U)))},
    {((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00001000U)), (0x1U << (10U)), ((0x3U << (10U)) | (0x3U << (8U))), ((0x2U << (10U)) | (0x3U << (8U)))},
    {((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00001000U)), (0x1U << (11U)), ((0x3U << (14U)) | (0x3U << (12U))), ((0x2U << (14U)) | (0x3U << (12U)))},
    {((GPIO_TypeDef *)((0x40000000U + 0x00010000U) + 0x00001000U)), (0x1U << (12U)), ((0x3U << (18U)) | (0x3U << (16U))), ((0x2U << (18U)) | (0x3U << (16U)))},
};
...
static void GPIOxL_Init(GPIO_TypeDef *GPIOx, uint32_t pin, uint32_t clear, uint32_t set)
{
    ...
    (((GPIOx->CRL)) = ((((((GPIOx->CRL))) & (~(clear))) | (set))));

    
    (((GPIOx->ODR)) = ((((((GPIOx->ODR))) & (~(pin))) | (0))));
}
...
void GPIO_Init()
{
    ...
    for (i=0;i<(sizeof(GPIO_PINS_L) / sizeof(GPIO_PINS_L[0]));++i) {
        GPIOxL_Init(GPIO_PINS_L[i].port, GPIO_PINS_L[i].pin, GPIO_PINS_L[i].clear, GPIO_PINS_L[i].set);
    }
    for (i=0;i<(sizeof(GPIO_PINS_H) / sizeof(GPIO_PINS_H[0]));++i) {
