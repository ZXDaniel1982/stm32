...
void SPI_Init()
{
	...
	MODIFY_REG(SPI1->CR1,
			   (SPI_CR1_CPHA | SPI_CR1_CPOL | SPI_CR1_MSTR | SPI_CR1_BR |
				SPI_CR1_LSBFIRST | SPI_CR1_SSI | SPI_CR1_SSM | SPI_CR1_RXONLY |
				SPI_CR1_DFF | SPI_CR1_CRCNEXT | SPI_CR1_CRCEN | SPI_CR1_BIDIOE |
				SPI_CR1_BIDIMODE),
			   (SPI_CR1_MSTR | SPI_CR1_SSI | SPI_CR1_CPOL | SPI_CR1_CPHA |
				SPI_CR1_SSM | SPI_CR1_BR_1 | SPI_CR1_BR_0));
